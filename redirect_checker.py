...
Deployed to /opt/redirect_checker.py on the EC2 box and run by the
redirect-checker systemd service. Keep this in sync with the copy
embedded in ec2_setup.sh (which provisions a fresh instance).
"""
import json
import os
import subprocess
